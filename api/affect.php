...
require('db.php');
    ...
    switch($method){
        ...
        if(isset($pat[4])  && ($pat[4] !== '')){
            ...
            $getuserrow=mysqli_query($db_connect, "SELECT  DISTINCT matiere.matricule_Ens, enseignant.nomE FROM matiere inner join enseignant ON matiere.matricule_Ens = enseignant.matricule_Ens WHERE classe='$userid'  ");
        ...
        case"PUT"://methode d'update
            ...
            $updatedata = mysqli_query($db_connect, "UPDATE classe SET enseignant_principal ='$ens'  WHERE id_classe='$userid' ");
            if($updatedata){
