    ...
    switch($method){
        ...
        if(isset($_FILES['photo'])){ //si la photo doit eter modifié
            ...
            $updatedata = mysqli_query($db_connect, "UPDATE eleve SET nom = '$nom', prenom = '$prénom', lieuNaiss = '$lieuNaiss', dateNaiss = '$dateNaiss', adresse = '$adresse', genre = '$genre', tuteur = '$tuteur',
                numero_tuteur = '$phone', photo = '$photo', niveau = '$niveau',classe = '$classe', annee_scolaire = '$scolaire',infos_supplementaire = '$message' WHERE matricule_El='$matricule' ");
                ...
                $updatedata = mysqli_query($db_connect, "UPDATE eleve SET nom = '$nom', prenom = '$prénom', lieuNaiss = '$lieuNaiss', dateNaiss = '$dateNaiss', adresse = '$adresse', genre = '$genre', tuteur = '$tuteur',
                numero_tuteur = '$phone', niveau = '$niveau',classe = '$classe', annee_scolaire = '$scolaire',infos_supplementaire = '$message' WHERE matricule_El='$matricule' ");
                 if($updatedata){
                    // en cas de succes
                    echo json_encode(["success"=>"eleve modifié avec succès"]);
                    return;
