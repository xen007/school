...
import Bulls from '../component/bulls';
...
export default function Notes(){//creation de la fonction principaae
    ...
    const getnoData = async() =>{
        const requestData = await fetch(`${config.apiBaseUrl}/seq.php/?` + new URLSearchParams({
            ns: ns,
        }).toString())
        ...
        return(
            ...
            <div className="col-sm-12">      
                    ...
                    <div className='container'>
                        <div className='row'>
                            <p id='vide'>AUCUN BULLETIN DISPONIBLE... </p>
                            <p id='vide'>VEUILLEZ REMPLIR LES NOTES OU VERIFIEZ  LES DATES REQUISES... </p>
                        </div>
                    </div>
            </main>
        )
                            ...
                            { //afficher les donnees recuperes
                                ...
                                <td className=''>
                                    <div className="btn-group " role="toolbar" aria-label="Toolbar with button groups">
                                            <Bulls data={no} num={index+1} ns={ns}/>
                                    </div>
                                </td>
                                </tr>
                                ))
