      ...
      */}
      ...
      <div id="tab" style={{ width: '100%', overflowX: 'auto', height: 'auto' }}>
        ...
        <table className='table table-striped table-bordered table-sm' style={{ width: '100%', tableLayout: 'auto' }}>
          ...
          <tbody>
            <tr>
            <td rowSpan="2">Total: {averages[matricule]?.totalNote1 + '/' + averages[matricule]?.totalBareme}<br />Moy/Avg: <strong>{averages[matricule]?.averageMois1}</strong></td>
              <td rowSpan="2">Total: {averages[matricule]?.totalNote2 + '/' + averages[matricule]?.totalBareme}<br />Moy/Avg: <strong>{averages[matricule]?.averageMois2}</strong></td>
              <td rowSpan="2">Total: {averages[matricule]?.totalNote3 + '/' + averages[matricule]?.totalBareme}<br />Moy/Avg: <strong>{averages[matricule]?.averageMois3}</strong></td>
