...
const Evaluation = () => {
  ...
  return (
      ...
      <div ref={(el) => (componentPdf = el)} style={{ width: '100%', padding: '20px 40px', fontSize: '10px' }}>
        {Object.keys(groupedData).map(matricule => (
          <div key={matricule}>
            ...
            <p>Date de Naissance: {groupedData[matricule].eleve.dateNaiss}</p>
            <div id="head">
      {/* entete du bulletin */}
      <div>
    ...
    <div id='middle'>
      ...
      <p><i> Discipline Travail Succès</i> </p>
      <p className="fw-bold">{}e Trimestre </p>
      <p> Année-scolaire: {groupedData[matricule].eleve.annee_scolaire|| '2024-2025'} </p>
    </div>
    <div id="head">
      ...
      <div id='botto'>
        ...
        <div >
          ...
          <p><strong>Né(e) le :</strong> {groupedData[matricule].eleve.dateNaiss|| 'N/A'} à {groupedData[matricule].eleve.LieuNaiss} </p>
